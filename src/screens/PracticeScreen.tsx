...
export function PracticeScreen() {
  ...
  const handlePracticePress = (practice: Practice) => {
    ...
    // SD4: bell + success haptic at practice end. SD2 (start-bell) is
    // deferred here too because PracticeScreen currently instant-logs —
    // start and end fire in the same handler microseconds apart, which
    // would interrupt the bell sample mid-play on the shared Audio.Sound
    // instance. When the practice-runner UI lands, SD1 (breath haptics),
    // SD2 (start-bell), SD3 (midpoint-bell at duration/2), and SD5 (voice
    // guidance) all attach to the runner. SensoryService already exposes
